...
namespace FormsLoyalty.Droid.Services.Media
{
    [Activity]
        ...
        : Activity
    {
            ...
            bool isPhoto, ref Uri path, Uri data)
        {
            ...
            return pathFuture.ContinueWith(t =>
            {
                ...
                return new MediaPickedEventArgs(requestCode, new FileNotFoundException());
            });
        }
        ...
        private static Uri GetOutputMediaFile(Context context, string subdir, string name, bool isPhoto)
        {
            ...
            var mediaType = (isPhoto) ? Android.OS.Environment.DirectoryPictures : Environment.DirectoryMovies;
            using (var mediaStorageDir = new Java.IO.File(context.GetExternalFilesDir(mediaType), subdir))
            {
                ...
                //return FileProvider.GetUriForFile(context, "com.LinkedGates.DelmarAttalla.fileprovider",  new Java.IO.File(MediaFileHelpers.GetUniqueMediaFileWithPath(isPhoto, mediaStorageDir.Path, name, File.Exists)));
            }
        }
