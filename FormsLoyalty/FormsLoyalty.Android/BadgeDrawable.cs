...
namespace FormsLoyalty.Droid
{
    public class BadgeDrawable : Drawable
    {
        ...
        public static void SetTabBadgeText(Context context, TabLayout.Tab item, string text, Color backgroundColor, Color textColor)
        {
            ...
            Drawable icon = new LayerDrawable(new Drawable[] { badge });
