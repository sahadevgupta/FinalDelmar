...
namespace LSRetail.Omni.Domain.DataModel.Loyalty.Orders
{
    ...
    { 
        ...
        {
            OrderStatus = SalesEntryStatus.Released;
            ...
            ContactAddress = new LSRetail.Omni.Domain.DataModel.Base.Retail.Address();
            ShipToAddress = new LSRetail.Omni.Domain.DataModel.Base.Retail.Address();
        }
        ...
        [DataMember]
        public LSRetail.Omni.Domain.DataModel.Base.Retail.Address ContactAddress { get; set; }
        [DataMember]
        ...
        [DataMember]
        public LSRetail.Omni.Domain.DataModel.Base.Retail.Address ShipToAddress { get; set; }
        [DataMember]
