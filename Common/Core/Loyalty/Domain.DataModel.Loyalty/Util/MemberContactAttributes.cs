...
namespace LSRetail.Omni.Domain.DataModel.Loyalty.Util
{
	public static class MemberContactAttributes
	{
		...
		public static class Registration
        {
			...
			public static readonly Tuple<bool, bool> Address1 = new Tuple<bool, bool>(true, true);
			...
			public static readonly Tuple<bool, bool> PostCode = new Tuple<bool, bool>(true, true);
            ...
            public static readonly Tuple<bool, bool> Mobile = new Tuple<bool, bool>(true, true);
            public static readonly Tuple<bool, bool> DateOfBirth = new Tuple<bool, bool>(true, false);
            public static readonly Tuple<bool, bool> Gender = new Tuple<bool, bool>(true, false);
